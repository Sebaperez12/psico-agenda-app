...
echo "================================================"
echo "✅ EMAIL - VERIFICACIÓN DE SETUP"
echo "================================================"
echo ""
...
echo "3. Configura REMINDER_JOB_KEY y BACKEND_BASE_URL"
echo "4. Inicia el backend: python app.py"
echo "5. En la UI: Turnos → turno reservado → Click Notificar"
echo "6. Para recordatorios automáticos: ./run_automatic_reminders.sh"
echo ""
