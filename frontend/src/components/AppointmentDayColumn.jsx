...
import { getLocalDateKey, formatDateForInput } from "../utils/dateUtils";
...
export default function AppointmentDayColumn({
  ...
  const getAvailableTimesForRange = useCallback((durationMinutes, excludedAppointmentId = null) => {
  ...
  }, [dayForm.duration, defaultDurationMinutes, getAvailableTimesForRange]);
